...
public class ParallelReverseServiceWithHttpStringReverserBenchmark {

    private final ReverseServer server = new ReverseServer();

    private final ReverseService service = new ParallelReverseService(new HttpStringReverser("http://localhost:8080"));
