...
public class AsyncReverseServiceWithHttpStringReverserBenchmark {

    private final ReverseServer server = new ReverseServer();

    private final ReverseService service = new AsyncReverseService(new HttpStringReverser("http://localhost:8080"));
